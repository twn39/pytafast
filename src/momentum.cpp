...
DoubleArrayOUT rsi(DoubleArrayIN inReal, int optInTimePeriod = 14) {
  ...
  return apply_ta_func(inReal.shape(0), TA_RSI_Lookback(optInTimePeriod), "TA_RSI",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_RSI(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInTimePeriod,
...
nb::tuple macd(DoubleArrayIN inReal, int optInFastPeriod = 12,
  ...
  return apply_ta_func_3out(inReal.shape(0), TA_MACD_Lookback(optInFastPeriod, optInSlowPeriod, optInSignalPeriod), "TA_MACD",
    [&](int* outBegIdx, int* outNBElement, double* out1, double* out2, double* out3) {
...
nb::tuple macdext(DoubleArrayIN inReal, int optInFastPeriod = 12,
  ...
  return apply_ta_func_3out(inReal.shape(0), TA_MACDEXT_Lookback(
      ...
      static_cast<TA_MAType>(optInSignalMAType)), "TA_MACDEXT",
    [&](int* outBegIdx, int* outNBElement, double* out1, double* out2, double* out3) {
      return TA_MACDEXT(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(),
...
nb::tuple macdfix(DoubleArrayIN inReal, int optInSignalPeriod = 9) {
  ...
  return apply_ta_func_3out(inReal.shape(0), TA_MACDFIX_Lookback(optInSignalPeriod), "TA_MACDFIX",
    [&](int* outBegIdx, int* outNBElement, double* out1, double* out2, double* out3) {
      return TA_MACDFIX(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(),
                           optInSignalPeriod, outBegIdx, outNBElement, out1, out2, out3);
    });
}
...
nb::tuple stoch(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func_2out(inHigh.shape(0), TA_STOCH_Lookback(optInFastK_Period, optInSlowK_Period,
                                   static_cast<TA_MAType>(optInSlowK_MAType),
                                   optInSlowD_Period,
                                   static_cast<TA_MAType>(optInSlowD_MAType)), "TA_STOCH",
    [&](int* outBegIdx, int* outNBElement, double* out1, double* out2) {
      return TA_STOCH(
          0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(), inLow.data(),
          inClose.data(), optInFastK_Period, optInSlowK_Period,
          static_cast<TA_MAType>(optInSlowK_MAType), optInSlowD_Period,
          static_cast<TA_MAType>(optInSlowD_MAType), outBegIdx, outNBElement, out1, out2);
    });
}
...
nb::tuple stochf(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func_2out(inHigh.shape(0), TA_STOCHF_Lookback(optInFastK_Period, optInFastD_Period,
                                    static_cast<TA_MAType>(optInFastD_MAType)), "TA_STOCHF",
    [&](int* outBegIdx, int* outNBElement, double* out1, double* out2) {
      return TA_STOCHF(
          0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(), inLow.data(),
          inClose.data(), optInFastK_Period, optInFastD_Period,
          static_cast<TA_MAType>(optInFastD_MAType), outBegIdx, outNBElement, out1, out2);
    });
}
...
nb::tuple stochrsi(DoubleArrayIN inReal, int optInTimePeriod = 14,
  ...
  return apply_ta_func_2out(inReal.shape(0), TA_STOCHRSI_Lookback(
      optInTimePeriod, optInFastK_Period, optInFastD_Period,
      static_cast<TA_MAType>(optInFastD_MAType)), "TA_STOCHRSI",
    [&](int* outBegIdx, int* outNBElement, double* out1, double* out2) {
      return TA_STOCHRSI(
...
DoubleArrayOUT roc(DoubleArrayIN inReal, int optInTimePeriod = 10) {
  ...
  return apply_ta_func(inReal.shape(0), TA_ROC_Lookback(optInTimePeriod), "TA_ROC",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_ROC(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInTimePeriod,
               outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT rocp(DoubleArrayIN inReal, int optInTimePeriod = 10) {
  ...
  return apply_ta_func(inReal.shape(0), TA_ROCP_Lookback(optInTimePeriod), "TA_ROCP",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_ROCP(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInTimePeriod,
                outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT rocr(DoubleArrayIN inReal, int optInTimePeriod = 10) {
  ...
  return apply_ta_func(inReal.shape(0), TA_ROCR_Lookback(optInTimePeriod), "TA_ROCR",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_ROCR(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInTimePeriod,
                outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT rocr100(DoubleArrayIN inReal, int optInTimePeriod = 10) {
  ...
  return apply_ta_func(inReal.shape(0), TA_ROCR100_Lookback(optInTimePeriod), "TA_ROCR100",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_ROCR100(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(),
...
DoubleArrayOUT mom(DoubleArrayIN inReal, int optInTimePeriod = 10) {
  ...
  return apply_ta_func(inReal.shape(0), TA_MOM_Lookback(optInTimePeriod), "TA_MOM",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_MOM(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInTimePeriod,
               outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT cmo(DoubleArrayIN inReal, int optInTimePeriod = 14) {
  ...
  return apply_ta_func(inReal.shape(0), TA_CMO_Lookback(optInTimePeriod), "TA_CMO",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_CMO(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInTimePeriod,
               outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT apo(DoubleArrayIN inReal, int optInFastPeriod = 12,
  ...
  return apply_ta_func(inReal.shape(0), TA_APO_Lookback(optInFastPeriod, optInSlowPeriod,
                                 static_cast<TA_MAType>(optInMAType)), "TA_APO",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_APO(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInFastPeriod,
               optInSlowPeriod, static_cast<TA_MAType>(optInMAType), outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT ppo(DoubleArrayIN inReal, int optInFastPeriod = 12,
  ...
  return apply_ta_func(inReal.shape(0), TA_PPO_Lookback(optInFastPeriod, optInSlowPeriod,
                                 static_cast<TA_MAType>(optInMAType)), "TA_PPO",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_PPO(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInFastPeriod,
               optInSlowPeriod, static_cast<TA_MAType>(optInMAType), outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT trix(DoubleArrayIN inReal, int optInTimePeriod = 30) {
  ...
  return apply_ta_func(inReal.shape(0), TA_TRIX_Lookback(optInTimePeriod), "TA_TRIX",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_TRIX(0, gsl::narrow<int>(inReal.shape(0) - 1), inReal.data(), optInTimePeriod,
                outBegIdx, outNBElement, outData);
    });
}
...
nb::tuple aroon(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func_2out(inHigh.shape(0), TA_AROON_Lookback(optInTimePeriod), "TA_AROON",
    [&](int* outBegIdx, int* outNBElement, double* out1, double* out2) {
      return TA_AROON(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(), inLow.data(),
...
DoubleArrayOUT aroonosc(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_AROONOSC_Lookback(optInTimePeriod), "TA_AROONOSC",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_AROONOSC(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(),
                            inLow.data(), optInTimePeriod, outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT adx(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_ADX_Lookback(optInTimePeriod), "TA_ADX",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
...
DoubleArrayOUT adxr(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_ADXR_Lookback(optInTimePeriod), "TA_ADXR",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
...
DoubleArrayOUT dx(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_DX_Lookback(optInTimePeriod), "TA_DX",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
...
DoubleArrayOUT minus_di(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_MINUS_DI_Lookback(optInTimePeriod), "TA_MINUS_DI",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_MINUS_DI(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(),
                      inLow.data(), inClose.data(), optInTimePeriod, outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT minus_dm(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_MINUS_DM_Lookback(optInTimePeriod), "TA_MINUS_DM",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_MINUS_DM(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(),
                            inLow.data(), optInTimePeriod, outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT plus_di(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_PLUS_DI_Lookback(optInTimePeriod), "TA_PLUS_DI",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_PLUS_DI(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(),
                           inLow.data(), inClose.data(), optInTimePeriod,
                           outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT plus_dm(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_PLUS_DM_Lookback(optInTimePeriod), "TA_PLUS_DM",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_PLUS_DM(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(),
                           inLow.data(), optInTimePeriod, outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT willr(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_WILLR_Lookback(optInTimePeriod), "TA_WILLR",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
...
DoubleArrayOUT mfi(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_MFI_Lookback(optInTimePeriod), "TA_MFI",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_MFI(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(), inLow.data(),
                 inClose.data(), inVolume.data(), optInTimePeriod, outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT cci(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_CCI_Lookback(optInTimePeriod), "TA_CCI",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
...
DoubleArrayOUT ultosc(DoubleArrayIN inHigh, DoubleArrayIN inLow,
  ...
  return apply_ta_func(inHigh.shape(0), TA_ULTOSC_Lookback(optInTimePeriod1, optInTimePeriod2, optInTimePeriod3), "TA_ULTOSC",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_ULTOSC(0, gsl::narrow<int>(inHigh.shape(0) - 1), inHigh.data(),
                        inLow.data(), inClose.data(), optInTimePeriod1,
                        optInTimePeriod2, optInTimePeriod3, outBegIdx, outNBElement, outData);
    });
}
...
DoubleArrayOUT bop(DoubleArrayIN inOpen, DoubleArrayIN inHigh,
  ...
  return apply_ta_func(inOpen.shape(0), TA_BOP_Lookback(), "TA_BOP",
    [&](int* outBegIdx, int* outNBElement, double* outData) {
      return TA_BOP(0, gsl::narrow<int>(inOpen.shape(0) - 1), inOpen.data(),
                       inHigh.data(), inLow.data(), inClose.data(), outBegIdx, outNBElement, outData);
    });
}
