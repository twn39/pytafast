...
from .plotters import (
    LinePlotter, BandPlotter, OscillatorPlotter, MACDPlotter,
    StochasticPlotter, AroonPlotter, ADXPlotter, TDIPlotter,
    KSTPlotter, SMIPlotter, IchimokuPlotter, ZigZagPlotter,
    SARPlotter, EMVPlotter, CMFPlotter, OBVPlotter, DPOPlotter,
    CLVPlotter, VolatilityPlotter, PatternsPlotter, EnvelopePlotter
)
...
INDICATOR_REGISTRY = {
    ...
    # Bands
    "BBANDS": {"plotter": BandPlotter, "default_kwargs": {"fillcolor": "rgba(173, 216, 230, 0.15)", "linecolor": "rgba(173, 216, 230, 0.4)"}},
    "KELTNERCHANNELS": {"plotter": BandPlotter, "default_kwargs": {"fillcolor": "rgba(255,165,0,0.1)", "linecolor": "rgba(255,165,0,0.3)", "mid_color": "orange"}},
    "KELTNER": {"plotter": BandPlotter, "function": "keltnerChannels", "default_kwargs": {"fillcolor": "rgba(255,165,0,0.1)", "linecolor": "rgba(255,165,0,0.3)", "mid_color": "orange"}},
    "DONCHIANCHANNEL": {"plotter": BandPlotter, "default_kwargs": {"fillcolor": "rgba(200,200,200,0.05)", "linecolor": "rgba(200,200,200,0.3)"}},
    "DONCHIAN": {"plotter": BandPlotter, "function": "DonchianChannel", "default_kwargs": {"fillcolor": "rgba(200,200,200,0.05)", "linecolor": "rgba(200,200,200,0.3)"}},
    "ENVELOPE": {"plotter": EnvelopePlotter, "default_kwargs": {"color": "rgba(0, 0, 255, 0.1)"}},
    "ICHIMOKU": {"plotter": IchimokuPlotter, "default_kwargs": {}},
    
    # Subplots - Oscillators (with thresholds)
    "RSI": {"plotter": OscillatorPlotter, "default_kwargs": {"yrange": [0, 100], "hlines": [30, 70], "color": "#9467bd"}},
    "CMO": {"plotter": OscillatorPlotter, "default_kwargs": {"yrange": [-100, 100], "hlines": [-50, 50]}},
    "WILLR": {"plotter": OscillatorPlotter, "default_kwargs": {"yrange": [-100, 0], "hlines": [-20, -80]}},
    
    # Subplots - Single line
    "ATR": {"plotter": LinePlotter, "default_kwargs": {"subplot": True, "height": 0.15}},
    "CCI": {"plotter": LinePlotter, "default_kwargs": {"subplot": True}},
    "MOM": {"plotter": LinePlotter, "default_kwargs": {"subplot": True}},
    "MOMENTUM": {"plotter": LinePlotter, "function": "MOM", "default_kwargs": {"subplot": True, "height": 0.2}},
    "MFI": {"plotter": LinePlotter, "default_kwargs": {"subplot": True, "yrange": [0, 100]}},
    ...
    "ADOSC": {"plotter": LinePlotter, "default_kwargs": {"subplot": True, "height": 0.2}},
    "CHAIKIN_OSC": {"plotter": LinePlotter, "function": "ADOSC", "default_kwargs": {"subplot": True, "height": 0.2}},
}
