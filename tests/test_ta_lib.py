...
def test_ema_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14, 30])
def test_rsi_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_macd_against_official_talib(random_prices):
    in_real = random_prices["real"]

    # default params: 12, 26, 9
    o_macd, o_signal, o_hist = talib.MACD(
        in_real, fastperiod=12, slowperiod=26, signalperiod=9
    )
    p_macd, p_signal, p_hist = pytafast.MACD(
        in_real, fastperiod=12, slowperiod=26, signalperiod=9
    )
...
@pytest.mark.parametrize("matype_val", [0, 1])
def test_bbands_against_official_talib(random_prices, matype_val):
    in_real = random_prices["real"]

    o_upper, o_middle, o_lower = talib.BBANDS(
        in_real, timeperiod=5, nbdevup=2.0, nbdevdn=2.0, matype=matype_val
    )
    p_upper, p_middle, p_lower = pytafast.BBANDS(
        in_real, timeperiod=5, nbdevup=2.0, nbdevdn=2.0, matype=matype_val
    )
...
def test_atr_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_adx_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_cci_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
def test_obv_against_official_talib(random_prices):
    in_real = random_prices["real"]
    in_vol = random_prices["volume"]
...
def test_roc_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("matype_val", [0, 1])
def test_stoch_against_official_talib(random_prices, matype_val):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]

    o_slowk, o_slowd = talib.STOCH(
        in_high,
        in_low,
        in_close,
        fastk_period=5,
        slowk_period=3,
        slowk_matype=matype_val,
        slowd_period=3,
        slowd_matype=matype_val,
    )
    p_slowk, p_slowd = pytafast.STOCH(
        in_high,
        in_low,
        in_close,
        fastk_period=5,
...
@pytest.mark.parametrize("period", [5, 10, 14])
def test_mom_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("nbdev", [1.0, 2.0])
@pytest.mark.parametrize("period", [5, 10, 14])
def test_stddev_against_official_talib(random_prices, nbdev, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_willr_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_natr_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_mfi_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
    in_vol = random_prices["volume"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_cmo_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_dx_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_minus_di_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_minus_dm_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_plus_di_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_plus_dm_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
...
@pytest.mark.parametrize("matype_val", [0, 1])
def test_apo_against_official_talib(random_prices, matype_val):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_aroon_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_aroonosc_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
...
@pytest.mark.parametrize("matype_val", [0, 1])
def test_ppo_against_official_talib(random_prices, matype_val):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 10])
def test_trix_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_ultosc_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]

    o_out = talib.ULTOSC(
        in_high, in_low, in_close, timeperiod1=7, timeperiod2=14, timeperiod3=28
    )
    p_out = pytafast.ULTOSC(
        in_high, in_low, in_close, timeperiod1=7, timeperiod2=14, timeperiod3=28
    )
    np.testing.assert_allclose(p_out, o_out, equal_nan=True)
...
@pytest.mark.parametrize("period", [5, 14, 30])
def test_dema_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14, 30])
def test_kama_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_ma_against_official_talib(random_prices):
    in_real = random_prices["real"]
    for matype_val in [
        0,
        1,
...
@pytest.mark.parametrize("period", [5, 10])
def test_t3_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14, 30])
def test_tema_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14, 30])
def test_trima_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14, 30])
def test_wma_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_sar_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
...
def test_trange_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
def test_avgprice_against_official_talib(random_prices):
    in_open = random_prices["open"]
...
def test_medprice_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
...
def test_typprice_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
def test_wclprice_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_midpoint_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_midprice_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
...
@pytest.mark.parametrize("period", [5, 14])
def test_adxr_against_official_talib(random_prices, period):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
def test_bop_against_official_talib(random_prices):
    in_open = random_prices["open"]
    in_high = in_open + np.random.random(100) * 5
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
def test_macdext_against_official_talib(random_prices):
    in_real = random_prices["real"]
...
def test_macdfix_against_official_talib(random_prices):
    in_real = random_prices["real"]
...
def test_stochf_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
...
@pytest.mark.parametrize("period", [5, 10])
def test_rocp_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 10])
def test_rocr_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [5, 10])
def test_rocr100_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_ad_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
    in_volume = random_prices["volume"]
    o_out = talib.AD(in_high, in_low, in_close, in_volume)
    p_out = pytafast.AD(in_high, in_low, in_close, in_volume)
    np.testing.assert_allclose(p_out, o_out, equal_nan=True)


def test_adosc_against_official_talib(random_prices):
    in_high = random_prices["high"]
    in_low = random_prices["low"]
    in_close = random_prices["close"]
    in_volume = random_prices["volume"]
    o_out = talib.ADOSC(
        in_high, in_low, in_close, in_volume, fastperiod=3, slowperiod=10
    )
    p_out = pytafast.ADOSC(
        in_high, in_low, in_close, in_volume, fastperiod=3, slowperiod=10
    )
    np.testing.assert_allclose(p_out, o_out, equal_nan=True)
...
@pytest.mark.parametrize("period", [5, 10])
def test_beta_against_official_talib(random_prices, period):
    in0 = random_prices["in0"]
    in1 = random_prices["in1"]
...
def test_correl_against_official_talib(random_prices, period):
    in0 = random_prices["in0"]
    in1 = random_prices["in1"]
...
def test_linearreg_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_linearreg_angle_against_official_talib(random_prices):
    in_real = random_prices["real"]
...
def test_linearreg_intercept_against_official_talib(random_prices):
    in_real = random_prices["real"]
...
def test_linearreg_slope_against_official_talib(random_prices):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [7, 14])
def test_tsf_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_var_against_official_talib(random_prices):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [7, 14])
def test_avgdev_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_add_against_official_talib(random_prices):
    in0 = random_prices["in0"]
    in1 = random_prices["in1"]
...
def test_sub_against_official_talib(random_prices):
    in0 = random_prices["in0"]
    in1 = random_prices["in1"]
...
def test_mult_against_official_talib(random_prices):
    in0 = random_prices["in0"]
    in1 = random_prices["in1"]
...
def test_div_against_official_talib(random_prices):
    in0 = random_prices["in0"]
    in1 = random_prices["in1"]
...
@pytest.mark.parametrize("period", [10, 30])
def test_max_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [10, 30])
def test_min_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
@pytest.mark.parametrize("period", [10, 30])
def test_sum_against_official_talib(random_prices, period):
    in_real = random_prices["real"]
...
def test_minmax_against_official_talib(random_prices):
    in_real = random_prices["real"]
...
def test_minmaxindex_against_official_talib(random_prices):
    in_real = random_prices["real"]
    ...
    np.testing.assert_array_equal(
        np.array(p_minidx)[lookback:], np.array(o_minidx)[lookback:].astype(int)
    )
    np.testing.assert_array_equal(
        np.array(p_maxidx)[lookback:], np.array(o_maxidx)[lookback:].astype(int)
    )


def test_ht_dcperiod_against_official_talib(random_prices):
...
def test_ht_dcphase_against_official_talib(random_prices):
    in_real = np.cumsum(np.random.random(200) - 0.5) + 100
...
def test_ht_phasor_against_official_talib(random_prices):
    in_real = np.cumsum(np.random.random(200) - 0.5) + 100
...
def test_ht_sine_against_official_talib(random_prices):
    in_real = np.cumsum(np.random.random(200) - 0.5) + 100
...
def test_ht_trendline_against_official_talib(random_prices):
    in_real = np.cumsum(np.random.random(200) - 0.5) + 100
...
def test_ht_trendmode_against_official_talib(random_prices):
    in_real = np.cumsum(np.random.random(200) - 0.5) + 100
