...
uv run python scripts/validation/compute_all_py.py

echo -e "\n--- 2. Computing R results ---"
OUTPUT_FILE="temp_r_results.csv" Rscript scripts/validation/compute_all_r.R
...
R_FILE="temp_r_results.csv" uv run python scripts/validation/final_compare.py
